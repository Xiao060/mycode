# 0 "test_push_no_pop.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test_push_no_pop.c"
...
# 385 "/usr/include/bits/socket.h" 3 4
...
extern void vsyslog (int __pri, const char *__fmt, __gnuc_va_list __ap)
     __attribute__ ((__format__ (__printf__, 2, 0)));
# 215 "/usr/include/sys/syslog.h" 3 4
...
# 23 "/usr/include/bits/shm.h" 3 4
# 1 "/usr/include/bits/wordsize.h" 1 3 4
# 24 "/usr/include/bits/shm.h" 2 3 4
# 1 "/usr/include/bits/shmlba.h" 1 3 4
# 23 "/usr/include/bits/shmlba.h" 3 4
...
# 1 "/usr/include/bits/types/struct_shmid_ds.h" 1 3 4
# 24 "/usr/include/bits/types/struct_shmid_ds.h" 3 4
struct shmid_ds
  {
    ...
    size_t shm_segsz;
# 39 "/usr/include/bits/types/struct_shmid_ds.h" 3 4
    __time_t shm_atime;
    __time_t shm_dtime;
    __time_t shm_ctime;
...
# 46 "/usr/include/bits/shm.h" 2 3 4
# 1 "/usr/include/bits/types/struct_shmid64_ds.h" 1 3 4
# 47 "/usr/include/bits/shm.h" 2 3 4
# 61 "/usr/include/bits/shm.h" 3 4
struct shminfo
  {
...
# 2 "test_push_no_pop.c" 2


# 3 "test_push_no_pop.c"
...
int main(int argc, char* argv[]) {
    ...
    pthread_t tid;
    pthread_create(&tid, 
# 9 "test_push_no_pop.c" 3 4
                        ((void *)0)
# 9 "test_push_no_pop.c"
                            , threadFunc, 
# 9 "test_push_no_pop.c" 3 4
                                          ((void *)0)
# 9 "test_push_no_pop.c"
...
# 18 "test_push_no_pop.c"
   p
# 18 "test_push_no_pop.c" 3 4
   ); int __not_first_call = __sigsetjmp_cancel (__cancel_buf.__cancel_jmp_buf, 0); if (__builtin_expect ((__not_first_call), 0)) { __cancel_routine (__cancel_arg); __pthread_unwind_next (&__cancel_buf); } __pthread_register_cancel (&__cancel_buf); do {
# 18 "test_push_no_pop.c"
                                      ;
    ...
    pthread_exit(
# 23 "test_push_no_pop.c" 3 4
                ((void *)0)
# 23 "test_push_no_pop.c"
                    );
...
# 30 "test_push_no_pop.c"
    ...
    return 
# 32 "test_push_no_pop.c" 3 4
          ((void *)0)
# 32 "test_push_no_pop.c"
              ;
}
